		  ...
		  switch (x)
			...
			do{
				...
				if (chaine.equals(ch1)) {t=1;}
					...
					// la chaine saisie qui n'egale pas à '***' sera verifier en lanceant l'appel de la fonction verif 
					// si le mot dans les conditions demandés , il sera ajouter dans la liste de l'utilisateur
			...
			else System.out.println("Bravo ! Vous avez gagné!");
			break ;}
		
			default : {System.out.println(" Il faut taper 1 ou 0!");
			break;}}
		
		System.out.println("Vous êtes sur vous-voulez quitter maintenant \n Si oui Tapez  :0 \n Sinon  Tapez :1 ");
		test=s.nextInt();
		}while(test==1);
	}
}
